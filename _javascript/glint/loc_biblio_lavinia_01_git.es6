...
/* ========================================================================== */
function snip_carousel_athena_51B_items_01(tpl_config, json_configuratie, data_tpl_carousel, loc_path_klant_media = json_configuratie.glint_path_klant_media) {
  ...
  `;
    ...
    return renderSnip({ loc_path_klant_media, fotos: data_tpl_carousel.fotos });
}
/* ========================================================================== */
...
function generate_prose_01(json_configuratie) {
  ...
  let tpl_gen_prose = `
    prose:
      rooturl: '${json_configuratie.glint_github_root}'
      siteurl: '${json_configuratie.glint_url_abs}'
