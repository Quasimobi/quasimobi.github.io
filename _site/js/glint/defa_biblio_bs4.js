 ...
 * Escaping zie http://exploringjs.com/es6/ch_template-literals.html#_text-templating-via-untagged-template-literals
 * Lodash kan dit ook.
 ...
 */
function render_template_02(anker_id, tpl_totaal, dummie = false) {
  ...
  toonInhoud_01(anker_id_02, tpl_totaal, knop_tekst); 
}
/* ========================================================================== */
/**
 * @param  {} anker_id
...
function docu_render_01(anker_id, docu_kode_01) {
  ...
  let tpl_docu_string = `<pre><div class="docu_render_01">`;
  tpl_docu_string = tpl_docu_string+`<h1>Render</h1>`;
 ...
 * @param  {} docu_block_01
 */
function docu_block_01(anker_id, docu_kode_01) {

  let tpl_docu_string = `<pre><div class="docu_block_01">`;
  tpl_docu_string = tpl_docu_string+`<h3>Block</h3>`;  
